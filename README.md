...
- [Main branch](https://github.com/Squaduck/Graveler/tree/main) - All performance notes above apply.
...
- [No Vectors branch](https://github.com/Squaduck/Graveler/tree/no_vectors) - **You are here.** Only uses 64-bit `POPCNT`. I don't know if this will perform better anywhere because 256-bit vectors can be emulated in software.
...
- [Parallel.For branch](https://github.com/Squaduck/Graveler/tree/ParallelFor) - **You are here.** Should support non-equal CPU cores better, at the cost of having extra overhead to manage the thread pool.
